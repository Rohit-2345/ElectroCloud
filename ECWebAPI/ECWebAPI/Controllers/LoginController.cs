...
namespace ECWebAPI.Controllers
{
    ...
    public class LoginController : ApiController
    {
        ...
        public string Post(Login login)
        {
            ...
            Customer_Table customer =  db.Register.Where(c => c.email == login.email).FirstOrDefault();
            if(customer == null)
            {
                return "User Not Found";
            }
            string pass = Decrypt(customer.password);
            if(login.password == pass)
            {
                    if(customer.email == "adminEC@electrocloud.com")
                    {
                        //var username = customer.fname + customer.lname;
